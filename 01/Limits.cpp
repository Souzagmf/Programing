...
int main() {
    ...
    std::cout << "Double:             " << std::setw(space) << std::numeric_limits<float>::min() << std::setw(space) << std::numeric_limits<float>::max() << std::endl;
    ...
    std::cout << "Long Double:        " << std::setw(space) << std::numeric_limits<long float>::min() << std::setw(space) << std::numeric_limits<long float>::max() << std::endl;
